...
async function testSupabaseConnection() {
    ...
    try {
        const { data, error } = await supabase
            .from('RainowTrout') // Tente buscar de uma de suas tabelas principais
...
async function fetchBoxLocations() {
    ...
    try {
        ...
        console.log("fetchBoxLocations: Dados brutos de RainowTrout_BOX recebidos:", data);
...
async function fetchSeabassData() {
    console.log("fetchSeabassData: Tentando buscar todos os dados de RainowTrout...");
    try {
        const { data, error } = await supabase
            .from('RainowTrout')
            .select(`
                ...
                "view.efficiency(%)",
                "view.observations",
                "hk.biorad-cfx384.temperature_annealing",
                "hk.biorad-cfx384.slope",
                "hk.biorad-cfx384.efficiency",
                "hk.biorad-cfx384.efficiency(%)",
                "hk.biorad-cfx384.observations",
                "pituitary-gland.biorad-cfx384.temperature_annealing",
                "pituitary-gland.biorad-cfx384.slope",
                "pituitary-gland.biorad-cfx384.efficiency",
                "pituitary-gland.biorad-cfx384.efficiency(%)",
                "pituitary-gland.biorad-cfx384.observations",
                "anterior-intestine.biorad-cfx384.temperature_annealing",
                "anterior-intestine.biorad-cfx384.slope",
                "anterior-intestine.biorad-cfx384.efficiency",
                "anterior-intestine.biorad-cfx384.efficiency(%)",
                "anterior-intestine.biorad-cfx384.observations",
                "hypothalamus.biorad-cfx384.temperature_annealing",
                "hypothalamus.biorad-cfx384.slope",
                "hypothalamus.biorad-cfx384.efficiency",
                "hypothalamus.biorad-cfx384.efficiency(%)",
                "hypothalamus.biorad-cfx384.observations",
                "liver.biorad-cfx384.temperature_annealing",
                "liver.biorad-cfx384.slope",
                "liver.biorad-cfx384.efficiency",
                "liver.biorad-cfx384.efficiency(%)",
                "liver.biorad-cfx384.observations",
                "skin.biorad-cfx384.temperature_annealing",
                "skin.biorad-cfx384.slope",
                "skin.biorad-cfx384.efficiency",
                "skin.biorad-cfx384.efficiency(%)",
                "skin.biorad-cfx384.observations",
                "gills.biorad-cfx384.temperature_annealing",
                "gills.biorad-cfx384.slope",
                "gills.biorad-cfx384.efficiency",
                "gills.biorad-cfx384.efficiency(%)",
                "gills.biorad-cfx384.observations"
            `);

        if (error) {
            console.error("fetchSeabassData: ERRO ao buscar dados de RainowTrout:", error.message);
            return [];
        }

        allSeabassSamples = data;
        console.log("fetchSeabassData: Dados de RainowTrout buscados com sucesso:", allSeabassSamples);
        return data;
    } catch (error) {
        console.error("fetchSeabassData: ERRO inesperado ao buscar dados de RainowTrout:", error);
        return [];
    }
}
...
function displayDetails(primerData) {
    ...
    const detailMapping = {
        ...
        // SEM TITULO
        'view-slope': 'view.slope',
        'view-efficiency': 'view.efficiency',
        'view-efficiency-percent': 'view.efficiency(%)',
        'view-observations': 'view.observations',

        // Hk
        'hk-temperature-annealing': 'hk.biorad-cfx384.temperature_annealing',
        'hk-slope': 'hk.biorad-cfx384.slope',
        'hk-efficiency': 'hk.biorad-cfx384.efficiency',
        'hk-efficiency-percent': 'hk.biorad-cfx384.efficiency(%)',
        'hk-observations': 'hk.biorad-cfx384.observations',

        // pituitary
        'pituitary-temperature-annealing': 'pituitary-gland.biorad-cfx384.temperature_annealing',
        'pituitary-slope': 'pituitary-gland.biorad-cfx384.slope',
        'pituitary-efficiency': 'pituitary-gland.biorad-cfx384.efficiency',
        'pituitary-efficiency-percent': 'pituitary-gland.biorad-cfx384.efficiency(%)',
        'pituitary-observations': 'pituitary-gland.biorad-cfx384.observations',

        // anterior
        'anterior-temperature-annealing': 'anterior-intestine.biorad-cfx384.temperature_annealing',
        'anterior-slope': 'anterior-intestine.biorad-cfx384.slope',
        'anterior-efficiency': 'anterior-intestine.biorad-cfx384.efficiency',
        'anterior-efficiency-percent': 'anterior-intestine.biorad-cfx384.efficiency(%)',
        'anterior-observations': 'anterior-intestine.biorad-cfx384.observations',

        // hypothalamus
        'hypothalamus-temperature-annealing': 'hypothalamus.biorad-cfx384.temperature_annealing',
        'hypothalamus-slope': 'hypothalamus.biorad-cfx384.slope',
        'hypothalamus-efficiency': 'hypothalamus.biorad-cfx384.efficiency',
        'hypothalamus-efficiency-percent': 'hypothalamus.biorad-cfx384.efficiency(%)',
        'hypothalamus-observations': 'hypothalamus.biorad-cfx384.observations',

        // liver
        'liver-temperature-annealing': 'liver.biorad-cfx384.temperature_annealing',
        'liver-slope': 'liver.biorad-cfx384.slope',
        'liver-efficiency': 'liver.biorad-cfx384.efficiency',
        'liver-efficiency-percent': 'liver.biorad-cfx384.efficiency(%)',
        'liver-observations': 'liver.biorad-cfx384.observations',

        // skin
        'skin-temperature-annealing': 'skin.biorad-cfx384.temperature_annealing',
        'skin-slope': 'skin.biorad-cfx384.slope',
        'skin-efficiency': 'skin.biorad-cfx384.efficiency',
        'skin-efficiency-percent': 'skin.biorad-cfx384.efficiency(%)',
        'skin-observations': 'skin.biorad-cfx384.observations',

        // gills
        'gills-temperature-annealing': 'gills.biorad-cfx384.temperature_annealing',
        'gills-slope': 'gills.biorad-cfx384.slope',
        'gills-efficiency': 'gills.biorad-cfx384.efficiency',
        'gills-efficiency-percent': 'gills.biorad-cfx384.efficiency(%)',
        'gills-observations': 'gills.biorad-cfx384.observations'
    };
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (errorSeabass || errorBox) {
        ...
        console.error("Erro ao excluir da RainowTrout:", errorSeabass);
        console.error("Erro ao excluir da RainowTrout_BOX:", errorBox);
        return;
    }
...
document.getElementById('editBoxCountBtn').addEventListener('click', async () => {
  ...
  const { data, error } = await supabase
    .from('config')
    .select('num_boxes')
    .eq('page', 'RainowTrout') // ajuste o nome da página conforme sua base
    .single();
...
async function fetchBoxCount() {
  try {
    const { data, error } = await supabase
      .from('config')
      .select('num_boxes')
      .eq('page', 'RainowTrout') // nome da página
      .single();
